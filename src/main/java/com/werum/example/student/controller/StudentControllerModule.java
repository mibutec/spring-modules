 ...
 */
public class StudentControllerModule extends ModuleDefinition {

    public StudentControllerModule() {
        super(StudentControllerComponentConfiguration.class, StudentServiceModule.class);
    }
